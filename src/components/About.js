...
import hero from "../pics/hero4.JPG";

const About = () => {
    return (
        <div className="w-4/5 h-1/2 mx-auto bg-white shadow-xl py-4 flex flex-col text-center justify-center align-middle">
            <img src={hero} alt="profile" className="h-60 w-60 object-cover mx-auto rounded-full shadow-2xl"/>
            <h1 className="mt-10 text-3xl">Mohan govind nagabhiru</h1>
            <h6 className="mt-10 text-xl w-3/5 mx-auto opacity-80">I'm passionate about technology and learning, and I find happiness in building applications that improve and empower people's lives.</h6>
