...
import {SiReact,SiTailwindcss,SiFirebase,SiJavascript,SiHtml5,SiAndroid} from 'react-icons/si'

const Stack = () => {
    return (
        <div className="w-4/5 h-1/2 mx-auto py-4 flex flex-col text-center justify-center align-middle bg-gray-600" id="stack">
           <h1 className="text-3xl text-white font-medium">Tech Stack</h1>
            <div className="flex flex-wrap justify-center pt-2">
              ...
              <div className="flex flex-col w-40 p-10 m-4 bg-white">
                        <SiAndroid color="lightgreen" className="mx-auto text-3xl" />
